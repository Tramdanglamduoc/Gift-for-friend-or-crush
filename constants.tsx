...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    content: {
      vi: "Có những lúc bạn thấy tui né bạn,\nhoặc cố tình tạo khoảng cách,\nthậm chí là gạt bạn ra khỏi cuộc sống của tui.\n\nKhông phải vì tui ghét bạn đâu.\nChỉ là vì tui sợ.\nTui sợ tui thích bạn —\ntheo một cách không còn đơn giản chỉ là bạn bè nữa.\n\nTui không quen với cảm xúc đó,\nvà cũng không giỏi xử lý nó.\nNên cách duy nhất tui nghĩ ra\nlà né tránh,\nlà cắt đi,\ndù trong lòng tui chưa từng muốn làm vậy.\n\nRồi tui lại hối hận,\nrồi lại quay về như cũ,\ncứ lặp đi lặp lại —\nmột vòng tròn không có điểm dừng.\n\nCó lẽ lúc này tui cũng nhận ra\ntui không cứng rắn như tui vẫn tưởng.\n\nNghe có hơi buồn cười ha?\n\nChắc do tui độc thân lâu quá,\ngặp một người tử tế một chút\nlà dễ rung động liền.\nMà còn chưa gặp ngoài đời nữa chứ.\n\nNhưng tui nghĩ tui không phải kiểu người\ndễ thích ai đó như vậy,\nnên việc tui có cảm xúc với bạn\ncũng phần nào cho thấy\nbạn là một người rất có sức hút.\n\nTui nói ra không phải để bạn phải làm gì cả.\nTui chỉ muốn nhẹ lòng hơn thôi.\nVì với tui,\nviệc thích một người\nlà một chuyện khá nặng lòng.\n\nTui xin lỗi,\nvì tui là một người chưa từng thật sự quen\nvà thích ai một cách để tâm hoàn toàn cả.\n\nVà thường mỗi lần tui có cảm xúc với ai đó,\nphản xạ đầu tiên của tui\nlại là đẩy người ta ra xa.\n\nNhưng lần này,\ntui chọn nói ra.\nÍt nhất thì tui nghĩ\ntui đã dũng cảm hơn chính tui của trước đây.\nVì trước giờ,\nmỗi lần crush ai\ntui đều im lặng hết.\n\nVới lại,\nkhi nói ra rồi,\ntui cũng đang nói rõ với chính mình,\nđể tự bản thân dễ đi qua\ngiai đoạn cảm nắng, trúng gió này hơn.\n\nCó một điều nữa,\ntui nói ra sự thích này từ trong lòng.\nVì tui biết\nbạn là một người rất có giá trị,\nvà việc có người thích bạn\nlà điều rất bình thường —\nthậm chí là điều bạn cũng nên biết.\n\nVà tui cũng biết rằng\ntui là một người có giá trị.\nViệc bạn không thích tui\nkhông làm điều đó mất đi.\n\nNên nếu bạn đã biết rồi,\ntui mong bạn đừng gieo hy vọng cho tui nha.\n\nNhân quả không chừa một ai đâu.\nGieo hy vọng cho người khác,\nrồi sẽ có một ngày\nbị đối xử y như vậy.\n\nHiện tại,\ntui chỉ đang thích thôi.\nRồi từ từ, cảm xúc này cũng sẽ qua.\n\nKhi nào hết thích,\ntui sẽ nói cho bạn biết,\nđể tụi mình vẫn có thể trò chuyện\nnhư những người bạn bình thường.\n\nVà bạn cũng không cần phải tránh né tui đâu,\ntại tui sẽ làm điều đó thay bạn.\nTui biết thế nào là chừng mực.\n\nTui không mong gì hơn cả,\nchỉ mong bạn luôn vui vẻ\nlà đủ rồi.",
      en: "There are times when you might notice that I avoid you,\nor deliberately keep my distance,\nsometimes even pushing you out of my life.\n\nIt’s not because I dislike you.\nIt’s because I’m scared.\nI’m scared that I like you —\nin a way that goes beyond just friendship.\n\nI’m not used to that kind of feeling,\nand I’m not good at handling it either.\nSo the only way I know how to cope\nis to avoid it,\nto cut it off,\neven though I never truly want to.\n\nThen I regret it,\nthen I return to how things were,\nover and over again —\na cycle that never really ends.\n\nI guess I’ve come to realize\nthat I’m not as strong as I thought I was.\n\nIt sounds a little ridiculous, doesn’t it?\n\nMaybe it’s because I’ve been single for too long.\nMeeting someone kind\nis enough to make my heart flutter.\nAnd we haven’t even met in real life.\n\nBut I don’t think I’m someone\nwho falls for people easily,\nso the fact that I developed feelings for you\nonly proves that\nyou’re someone truly special.\n\nI’m not saying this because I expect anything from you.\nI just want to feel a little lighter.\nFor me,\nliking someone\nhas always been a heavy thing to carry.\n\nI’m sorry,\nbecause I’ve never really known\nhow to truly love or be close to someone.\n\nThat’s why every time I start liking someone,\nmy first instinct\nis to push them away.\n\nBut this time,\nI chose to speak up.\nAt the very least,\nI think I’m braver than the version of me before.\nBecause in the past,\nevery crush\nwas met with silence.\n\nAnd by saying this out loud,\nI’m also being honest with myself,\nso I can move through\nthis fleeting phase of feelings more gently.\n\nOne more thing —\nI’m saying this sincerely, from my heart.\nBecause I know\nyou are someone of great value,\nand being liked by someone\nis completely normal —\neven something you deserve to know.\n\nAnd I also know\nthat I have my own value too.\nThe fact that you don’t like me back\ndoesn’t take that away.\n\nSo now that you know,\nI hope you won’t give me false hope.\n\nCause karma never misses anyone.\nIf you plant hope in someone’s heart,\none day\nyou might be treated the same way.\n\nRight now,\nI’m just liking you.\nAnd slowly, that feeling will fade.\n\nWhen it does,\nI’ll let you know,\nso we can continue talking\nas normal friends.\n\nYou don’t have to avoid me —\nI’ll take care of that part myself.\nI know where the line is.\n\nI don’t wish for anything more.\nI just hope\nyou’re always happy."
    },
    warning: true
  },
  {
